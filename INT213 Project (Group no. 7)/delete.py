...
class Database:
    def __init__(self,root):
         ...
         self.heading=Label(self.master,text="Delete from the databse",font=('arial 40 bold'),fg='#ebebeb',bg='#000000')
         ...
         self.id_le=Label(self.master,text="Enter ID",font=('arial 18 bold'),fg='#ebebeb',bg='#000000')
         ...
         self.btn_search=Button(self.master,text="search",font=('arial 12 bold'),width=12,height=1,bg='#e6739f',fg='#ffffff',command=self.search) 
         self.btn_search.place(x=550,y=70+50)
         ...
         self.btn_add=Button(self.master,text='Delete from Database',font=('arial 12 bold'),width=20,height=2,bg='#003f5c',fg='white',command=self.delete)
         self.btn_add.place(x=500,y=320+55)
    ...
    def delete(self):
         ...
         tkinter.messagebox.showinfo("Success","Deleted '" + str(self.n1) + "' from database with code '" + str(self.n0) + "' successfully")
